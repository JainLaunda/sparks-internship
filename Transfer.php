...
<head> 
    ...
    .transferMoney{
        ...
        background: linear-gradient(to bottom, yellow, lightgreen);
        padding: 20px;
        position:fixed;
        top:50%;
        left:50%;
...
<div class = 'transferMoney'>
    ...
    <!-- To structurise form it is put in a table--onsubmit="return validateForm()"-->
        ...
        <tr>
            ...
            <td> <B><input type="submit" value="PROCEED"></B><td>
        </tr>
